...
class Museus : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerView.adapter = MonumentAdapter(emptyList(), placesClient, this)
    ...
    private fun updateRecyclerView(places: List<Place>) {
        ...
        if (places.isNotEmpty()) {
            ...
            recyclerView.adapter = MonumentAdapter(places, placesClient, this) // Não esqueça de passar o placesClient para o adapter
        } else {
